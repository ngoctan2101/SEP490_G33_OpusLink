...
namespace OpusLink.Entity.Configurations
{
    public class JobConfiguration : IEntityTypeConfiguration<Job>
    {
        public void Configure(EntityTypeBuilder<Job> builder)
        {
            ...
            builder.HasData(
                new Job {JobID=1, EmployerID=1,FreelancerID=5, JobTitle="Tim DEV", JobContent="Minh can 1 nguoi code web", BudgetFrom=300000,BudgetTo=500000, DateCreated = DateTime.ParseExact("2023-01-29 21:00", "yyyy-MM-dd HH:mm", CultureInfo.InvariantCulture),LocationID=1,Status="Hired" },
                ...
                new Job {JobID=3, EmployerID=2,FreelancerID=8, JobTitle="Thiet ke Database",JobContent="Can nguoi giup minh thiet ke DataBase cho trang web giao duc", BudgetFrom = 400000, BudgetTo = 1000000, DateCreated = DateTime.ParseExact("2023-01-29 22:00", "yyyy-MM-dd HH:mm", CultureInfo.InvariantCulture), LocationID = 2, Status = "Hired" }
                );
        }
    }
}
